...
def downgrade() -> None:
    print("WARNING: This downgrade deletes all prev. data in Mileage table. You must copy all prev. data from MileageHistory table.")
    op.execute("DELETE FROM mileage")
    # ### commands auto generated by Alembic - please adjust! ###
