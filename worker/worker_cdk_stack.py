...
class WorkerStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        tracker = _lambda.Function(
            ...
            code=_lambda.AssetCode("worker", exclude=exclude_list),
            handler="function.tracker.track_tx",
            layers=[layer],
            role=role,
            vpc=shared_stack.vpc,
        ...
        garage_report = _lambda.Function(
            ...
            code=_lambda.AssetCode("worker", exclude=exclude_list),
            handler="function.garage_noti.noti",
            layers=[layer],
            role=role,
            vpc=shared_stack.vpc,
        ...
        gd_handler = _lambda.Function(
            ...
            code=_lambda.AssetCode("worker", exclude=exclude_list),
            handler="function.golden_dust_by_ncg.handle_request",
            layers=[layer],
            role=role,
            vpc=shared_stack.vpc,
        ...
        gd_tracker = _lambda.Function(
            ...
            code=_lambda.AssetCode("worker", exclude=exclude_list),
            handler="function.golden_dust_by_ncg.track_tx",
            layers=[layer],
            role=role,
            vpc=shared_stack.vpc,
            timeout=cdk_core.Duration.seconds(50),
